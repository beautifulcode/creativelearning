module Jabberwock # :nodoc:
  ...
  # raised when an unkown reflection type is encountered.
  # This is usually caused by reflections being set up incorrectly in the model
  class UnknownReflectionName < ActiveRecord::ActiveRecordError; end
  ...
  module SmartForm
    ...
    # The 'base' argument is the class that is including the module. I'm documenting this
